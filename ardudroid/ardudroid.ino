/*
 PROJECT: ArduDroid for Micro / Leonardo
 ORIGINAL PROGRAMMER: Hazim Bitar (techbitar at gmail dot com)
...
void loop()
{
  ...
  if(outText != "") Serial1.println(outText);
  Serial1.flush();
  int ard_command = 0;
  int pin_num = 0;
  int pin_value = 0;
